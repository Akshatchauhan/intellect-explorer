...
import { ArrowUpRight, Beaker, Layers, Lock } from 'lucide-react';
  ...
  if (allProjects.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center text-zinc-500 font-mono text-xs tracking-widest">
        [SYSTEM_MALFUNCTION]: NO_DATA_FOUND
      </div>
    );
  }
                      ...
                      <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                         <div className="flex justify-between items-end gap-4">
                            <div>
                              ...
                              {/* TITLE SCALING: text-2xl on mobile, break-words */}
